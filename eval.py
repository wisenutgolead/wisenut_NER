...
def main(args):
    ...
    for step_test, (
    x_text_batch, x_split_batch, padded_word_tokens_matrix, padded_char_tokens_matrix, padded_pos_tokens_matrix,
    padded_lex_tokens_matrix, labels, lengths) in enumerate(test_data_loader):
        try:
            ...
            predictions = cnn_bilstm_tagger(padded_word_tokens_matrix, padded_char_tokens_matrix,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_file_dir_test', type=str, default='./data_in/EXOBRAIN_NE_CORPUS_10000.txt')
    ...
    parser.add_argument('--model_load_path', type=str,
                        default='./data_in/cnn_bilstm_crf_tagger-2-600_f1_0.5810_maxf1_0.6437_100_100.pkl')
